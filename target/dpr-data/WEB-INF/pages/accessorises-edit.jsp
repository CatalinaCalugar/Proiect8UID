...
<head>
    ...
    <title>Edit Accessorises page</title>
...
<div id="body">
    <div id="content">
        ...
        <div class="content">
            ...
            <form:form method="POST" commandName="accessorises"
                       action="${pageContext.request.contextPath}/accessorises/edit/${accessorises.id}.html">
                <img align="middle" src="${accessorises.image}" width="500" height="350"/>
                <table>
                    <tbody>
                    <tr>
                        <td>ID:</td>
